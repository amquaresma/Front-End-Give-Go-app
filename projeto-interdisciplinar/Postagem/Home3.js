...
const ItemPostadoSucesso = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    Notifications.scheduleNotificationAsync({
      content: {
        title: "Parabéns!",
        body: "Seu item foi postado com sucesso. Alguém em breve irá retirar.",
      },
      trigger: null, 
    });
  }, []);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Item postado com sucesso!</Text>
        <Text style={styles.description}>
          A pessoa/instituição que reservar seu item irá vir retirá-lo no local indicado em algum momento
          dentro das datas e horários especificados por você.
        </Text>
      </View>
