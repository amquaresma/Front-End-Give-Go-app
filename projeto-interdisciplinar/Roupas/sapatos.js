  ...
  return (
    <View style={styles.container}>
     ...
     <ScrollView>
        ...
        <Image
          source={{ uri: 'https://s2-g1.glbimg.com/BPgfSxMhZFDCmEVtqTK1kb54F8A=/0x0:1043x577/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2019/T/N/Gq2CMJRMmH2tcbyNKFkw/tenis.jpg' }} 
          style={styles.itemImage}
        />

        <View style={styles.detailsContainer}>
          <Text style={styles.itemDescriptionTitle}>Descrição do Item:</Text>
          <Text style={styles.itemDescription}>Sapatos femininos - Tamanho 36</Text>

          <Text style={styles.itemDescriptionTitle}>Endereço:</Text>
          <Text style={styles.itemDescription}>
          Avenida João Rosa 185{'\n'}nº 666 - Sorocaba,  SP
          </Text>

          <Text style={styles.itemDescriptionTitle}>Responsável pela doação:</Text>
          <Text style={styles.itemDescription}>Lorena Martins</Text>

          <Text style={styles.itemDescriptionTitle}>
            Datas e horários disponíveis para a retirada:
          </Text>
          <Text style={styles.itemDescription}>
            Dias: 23/12/2024, 24/12/2024{'\n'}Horário: Das 09:00 - 20:00
          </Text>
        </View>
      </ScrollView>
