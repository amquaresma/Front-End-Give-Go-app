  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate("Scroll")}>
        ...
        <ScrollView>
        <Image
          source={{ uri: 'https://photos.enjoei.com.br/lote-roupas-doacao-70139811/800x800/czM6Ly9waG90b3MuZW5qb2VpLmNvbS5ici9wcm9kdWN0cy8xMTU4MTU2OS8xNWViZWMwYWVmNjIzYjRmZjkzZWM4YmUzMmFiNGY0Yy5qcGc' }} 
          style={styles.itemImage}
        />

        <View style={styles.detailsContainer}>
          <Text style={styles.itemDescriptionTitle}>Descrição do Item:</Text>
          <Text style={styles.itemDescription}>Roupas infantis - 2 a 4 anos</Text>

          <Text style={styles.itemDescriptionTitle}>Endereço:</Text>
          <Text style={styles.itemDescription}>
            Rua Vitória Jd. Esperança{'\n'} Nº 517 - Taboão da Serra
          </Text>

          <Text style={styles.itemDescriptionTitle}>Responsável pela doação:</Text>
          <Text style={styles.itemDescription}>Escola Municipal Maria Alice Borges Gion</Text>

          <Text style={styles.itemDescriptionTitle}>
            Datas e horários disponíveis para a retirada:
          </Text>
          <Text style={styles.itemDescription}>
            Dias:22/12/2024{'\n'}Horário: Das 07:30 às 13:00
          </Text>
        </View>
      </ScrollView>
