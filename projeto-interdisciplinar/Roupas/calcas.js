...
export default function ItemDetailsScreen({navigation}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        <Image
          source={{ uri: 'https://visitebrasilia.com.br/media/plg_jspeed/cache/images/a20a1a28c62d833b998b311e71f2d969c8b47bc2.webp' }}
          style={styles.itemImage}
        />

        <View style={styles.detailsContainer}>
          <Text style={styles.itemDescriptionTitle}>Descrição do Item:</Text>
          <Text style={styles.itemDescription}>Calças Jeans - Tamanho 40</Text>

          <Text style={styles.itemDescriptionTitle}>Endereço:</Text>
          <Text style={styles.itemDescription}>
            Rua José Antônio Jd. Paraíso{'\n'}Casa de Nº 45 - Taboão da Serra,  SP
          </Text>

          <Text style={styles.itemDescriptionTitle}>Responsável pela doação:</Text>
          <Text style={styles.itemDescription}>Elizângela</Text>
